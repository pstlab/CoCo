...
impl fmt::Display for KnowledgeBaseError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            KnowledgeBaseError::ObjectIDRequired => write!(f, "Object ID is required"),
            KnowledgeBaseError::ObjectClassesRequired(id) => write!(f, "Object classes are required for object: {}", id),
